...
5) Delete your account: :heavy_exclamation_mark:***Προσοχή*** Με αυτήν την επιλογή διαγράφεται ο λογαριασμός του χρήστη ***χωρίς*** κάποια δεύτερη προειδοποίηση.
...
|  ***ΠΡΟΣΟΧΗ Δεν υποστηρίζεται η λειτουργία σε περιβάλλον Windows ή MacOS αλλά μόνο Linux!***  |
