...
Εδώ υπάρχουν 3 επιλογές για τον διαχειριστή. Η πρώτη είναι Add a movie, η οποία οδηγεί στην σελίδα προσθήκης μιας νέας ταινίας στην βάση δεδομένων. Τα υποχρεωτικά πεδία είναι ο τίτλος και ένας πρωταγωνιστής.
